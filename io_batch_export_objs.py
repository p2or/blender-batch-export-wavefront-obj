...
bl_info = {
    ...
    "author": "p2or + Updated by Bastelkorb",
    "version": (0, 8, 0),
    "blender": (4, 5, 2),
    "location": "File > Import-Export",
    "description": "Import multiple OBJ files, UVs and their materials",
...
class WM_OT_batchWavefront(bpy.types.Operator, ImportHelper):
    ...
    global_scale_setting: FloatProperty(
        name="Scale",
        description="Value by which to enlarge or shrink objects",
    ...
    clamp_size_setting: FloatProperty(
        ...
        description="Resize objects to keep bounding box under this value. 0 disables clamping",
        min=0.0, max=1000.0,
    ...
    auto_center: BoolProperty(
        name="Auto-Center",
        description="Automatically move imported objects to world origin",
        default=True
    )
